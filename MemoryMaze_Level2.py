...
pygame.display.set_caption("Memory Maze: Level 2")
...
red_text = [font.render("0 / 2 Red", True, (255,0,0)), font.render("1 / 2 Red", True, (255,0,0)), font.render("2 / 2 Red", True, (255,0,0))]
green_text = [font.render("0 / 2 Green", True, (0,255,0)), font.render("1 / 2 Green", True, (0,255,0)), font.render("2 / 2 Green", True, (0,255,0))]
blue_text = [font.render("0 / 2 Blue", True, (0,0,255)), font.render("1 / 2 Blue", True, (0,0,255)), font.render("2 / 2 Blue", True, (0,0,255))]

finish_2 = font.render("You finished Level 2!", True, white)
...
def draw_maze():
    ...
    # draw circles
    # red
    pygame.draw.circle(screen, red, (450,250), 10, 0)
    pygame.draw.circle(screen, red, (150,550), 10, 0)
    # green
    pygame.draw.circle(screen, green, (250,150), 10, 0)
    pygame.draw.circle(screen, green, (450,450), 10, 0)
    # blue
    pygame.draw.circle(screen, blue, (350,250), 10, 0)
    pygame.draw.circle(screen, blue, (550,250), 10, 0)
...
def get_circles():
    global circle_order
    global red1, red2, green1, green2, blue1, blue2
    # red
    if (sprite_one.rect.centerx>=440 and sprite_one.rect.centerx<=460 and red1 == False):
        if (sprite_one.rect.centery>=240 and sprite_one.rect.centery<=260):
            if (circle_order == 0):
                circle_order = 1
                red1 = True
            elif (circle_order == 1):
                circle_order = 2
                red1 = True
    if (sprite_one.rect.centerx>=140 and sprite_one.rect.centerx<=160 and red2 == False):
        if (sprite_one.rect.centery>=540 and sprite_one.rect.centery<=560):
            if (circle_order == 0):
                circle_order = 1
                red2 = True
            elif (circle_order == 1):
                ...
                red2 = True
    # green
    if (sprite_one.rect.centerx>=240 and sprite_one.rect.centerx<=260 and sprite_one.rect.centery>=140 and sprite_one.rect.centery<=160 and green1 == False):
        if (circle_order == 2):
            circle_order = 3
            green1 = True
        elif (circle_order == 3):
            ...
            blue1 = False
            blue2 = False
    if (sprite_one.rect.centerx>=440 and sprite_one.rect.centerx<=460 and sprite_one.rect.centery>=440 and sprite_one.rect.centery<=460 and green2 == False):
        if (circle_order == 2):
            circle_order = 3
            green2 = True
        elif (circle_order == 3):
            ...
            blue2 = False
    # blue
    if (sprite_one.rect.centerx>=340 and sprite_one.rect.centerx<=360 and sprite_one.rect.centery>=240 and sprite_one.rect.centery<=260 and blue1 == False):
        if (circle_order == 4):
            circle_order = 5
            blue1 = True
        elif (circle_order == 5):
            ...
            blue1 = False
            blue2 = False
    if (sprite_one.rect.centerx>=540 and sprite_one.rect.centerx<=560 and sprite_one.rect.centery>=240 and sprite_one.rect.centery<=260 and blue2 == False):
        if (circle_order == 4):
            circle_order = 5
            blue2 = True
        elif (circle_order == 5):
